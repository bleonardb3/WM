...
In this lab, you will use a Jupyter Notebook to train a model using the XGBoost library to classify whether a person has heart disease or not. In addition to training, the notebook explains how to persist a trained model to the IBM Watson Machine Learning repository, deploy the model as a REST service and to predict using REST APIs.  

The heart disease prediction model will be trained and tested using an open source data set published in the University of California, Irvine (UCI) Machine Learning Repository.
...
> <img src="https://github.com/bleonardb3/WM/blob/master/Lab-4/Images/Heart%20Disease%20Notebook.png"/>
